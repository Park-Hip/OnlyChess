...
class FusionRuleTests(unittest.TestCase):
    ...
    def test_fusion_is_order_independent_for_shared_pieces(self):
        # Bishop capturing Knight also fuses into an Archbishop.
        self.assertEqual(get_fusion_result(BISHOP_CODE, KNIGHT_CODE), ARCHBISHOP_CODE)
        # Knight capturing Rook also fuses into a Chancellor.
    ...
    def test_invalid_fusion_pairs_return_none(self):
        ...
        self.assertIsNone(get_fusion_result(KNIGHT_CODE, KNIGHT_CODE))
